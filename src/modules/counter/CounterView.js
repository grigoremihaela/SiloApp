...
class CounterView extends Component {
  ...
  render() {
    ...
    const buttonText = 'Get temperature';

    return (
      <ScrollView >
      <View style={styles.container}>

        <Text style={styles.welcome}> Welcome to Silo Temperature! </Text>
        <Image
          style={styles.image}
          source={require('../../../images/silo.png')}
          resizeMode="stretch"
        />
...
*/}
        <TouchableOpacity
            accessible={true}
            accessibilityLabel={'Get temperature'}
            onPress={this.bored}>
          <Text style={styles.linkButton}>
            Get temperature
          </Text>
